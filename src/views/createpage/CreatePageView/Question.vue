    ...
    <el-card class="box-card" shadow="hover" :body-style="{ padding: '0' }">
      ...
      <div class="box-is-not-selected-wrapper" v-if="!isBoxSelected" @click="clickUnSelected">
        <div class="box-is-not-selected">
          ...
          <el-radio-group v-if="typeValue==='single_check'||typeValue==='multi_check'" v-model="optionScore">
            <el-radio v-for="(item,index) in optionScore" :key="index">{{ item }}</el-radio>
          </el-radio-group>
      ...
      <div class="box-is-selected" v-if="isBoxSelected">
        ...
        <el-form>
          ...
          <div v-if="typeValue==='single_check'||typeValue==='multi_check'">
            <el-form-item v-for="(item,index) in optionScore" :key="index">
              选项{{ index + 1 }}评分：
              <el-input v-model="optionScore[index]" style="max-width: 200px"></el-input>
              <el-tooltip effect="light"
                          content="在下方添加"
                          :open-delay="200"
                          :hide-after="1500"
...
export default {
  ...
  methods: {
    ...
    deleteOptionScore(index){
      this.optionScore.splice(index , 1);
    },
    addFrontOption() {
  ...
  data: function () {
    return {
      ...
      //
      optionScore: this.questionOptionsScore,
    }
  },
  computed: {
    questionData: function () {
      const questionData = {
        ...
        //
        questionOptionsScore: this.optionScore,
      };
      return questionData;
